...
Revision ID: 05e4d2c23edd
Revises: 
Create Date: 2022-08-08 12:41:07.916378
...
def upgrade():
    ...
    op.bulk_insert(venue,
                   [
                       {'id': 1, 'area': 5, 'name': 'The Musical Hop', 'address': '1015 Folsom Street', 'phone': '123-123-1234', 'website': 'https://www.themusicalhop.com',  'seeking_description': 'We are on the lookout for a local artist to play every two weeks. Please call us.', 'seeking_talent': True,
                       ...
                       {'id': 2, 'area': 28, 'name': 'The Dueling Pianos Bar', 'address': '335 Delancey Street', 'phone': '914-003-1132', 'website': 'https://www.theduelingpianos.com', 'facebook_link': 'https://www.facebook.com/theduelingpianos',
                       ...
                       {'id': 3, 'area': 5, 'name': 'Park Square Live Music & Coffee', 'address': '34 Whiskey Moore Ave', 'phone': '415-000-1234', 'website': 'https://www.parksquarelivemusicandcoffee.com',
    ...
    op.bulk_insert(artist, [
        ...
        {'id': 6, 'name': 'The Wild Sax Band', 'area': 5, 'facebook_link': None, 'phone': '432-325-5432',
    ...
    op.bulk_insert(genre_venue,
                   [
                       {'genre_id': 'Jazz', 'venue_id': 1},
                       {'genre_id': 'Reggae', 'venue_id': 1},
                       {'genre_id': 'Swing', 'venue_id': 1},
                       {'genre_id': 'Classical', 'venue_id': 1},
                       {'genre_id': 'Folk', 'venue_id': 1},
                       {'genre_id': 'Classical', 'venue_id': 2},
                       {'genre_id': 'R&B', 'venue_id': 2},
                       {'genre_id': 'Hip-Hop', 'venue_id': 2},
                       {'genre_id': 'Rock n Roll', 'venue_id': 3},
                       {'genre_id': 'Jazz', 'venue_id': 3},
                       {'genre_id': 'Classical', 'venue_id': 3},
                       {'genre_id': 'Folk', 'venue_id': 3},
                   ]
                   )

    op.bulk_insert(genre_artist,
                   [
                       {'genre_id': 'Rock n Roll', 'artist_id': 4},
                       {'genre_id': 'Jazz', 'artist_id': 5},
                       {'genre_id': 'Jazz', 'artist_id': 6},
                       {'genre_id': 'Classical', 'artist_id': 6},
                   ]
                   )
